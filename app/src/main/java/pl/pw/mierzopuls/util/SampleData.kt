...
object SampleData {
    val studies = listOf(
        Study(
            date = "01.03.2022_12:13",
            pulse = 72,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        ),
        Study(
            date = "09.04.2022_03:24",
            pulse = 88,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        ),
        Study(
            date = "19.05.2022_11:39",
            pulse = 82,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        ),
        Study(
            date = "22.07.2022_13:51",
            pulse = 65,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        ),
        Study(
            date = "25.07.2022_18:12",
            pulse = 87,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        ),
        Study(
            date = "25.07.2022_18:32",
            pulse = 96,
            userInfo = UserInfo("Dac", "18", "Male", "170", "170")
        )
    )
